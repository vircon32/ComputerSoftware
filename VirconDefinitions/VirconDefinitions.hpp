...
// -----------------------------------------------------------------------------
//  This file is the most basic Vircon header. It centralizes
//  the declaration of constants and also provides some common
//  general use functions used by most Vircon tools and programs
// *****************************************************************************
