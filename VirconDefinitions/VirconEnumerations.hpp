// *****************************************************************************
    // start include guard
    #ifndef VIRCONENUMERATIONS_HPP
    #define VIRCONENUMERATIONS_HPP
    ...
    // this fix may be needed for some Windows headers
    #undef IN
    #undef OUT
// -----------------------------------------------------------------------------
//  This file defines all enumeration-based values for the different
//  Vircon components. It also covers their conversions to and from
//  strings to support logging, assembly and disassembly.
// *****************************************************************************


// =============================================================================
//      ENUMERATIONS FOR THE WHOLE VIRCON SYSTEM
// =============================================================================
...
std::string OpCodeToString( InstructionOpCodes OpCode );
std::string RegisterToString( CPURegisters Register );
std::string PortToString( IOPorts Port );
std::string PortValueToString( IOPortValues Port );

// context-dependent conversion for specific port values
std::string GPUCommandToString( IOPortValues PortValue );
std::string SPUCommandToString( IOPortValues PortValue );
std::string GPUBlendingModeToString( IOPortValues PortValue );
std::string SPUChannelStateToString( IOPortValues PortValue );
...
InstructionOpCodes StringToOpCode( std::string& Word );
CPURegisters StringToRegister( std::string& Word );
IOPorts StringToPort( std::string& Word );
IOPortValues StringToPortValue( std::string& Word );
